...
CREATE TABLE DISTRIBUTOR (DNAME VARCHAR(15) PRIMARY KEY,ADDRESS VARCHAR(50));

CREATE TABLE DISTRI_PHONE (DNAME VARCHAR(15),PHONE BIGINT);

ALTER TABLE DISTRI_PHONE ADD CONSTRAINT DIS_PHN_FK FOREIGN KEY (DNAME) REFERENCES DISTRIBUTOR(DNAME);

CREATE OR REPLACE PROCEDURE ADD_DISTRI (NAMED IN DISTRIBUTOR.DNAME%TYPE ,ADDR IN DISTRIBUTOR.ADDRESS%TYPE ,PH1 IN DISTRI_PHONE.PHONE%TYPE)
...
CREATE OR REPLACE PROCEDURE DEL_DISTRI (NAMED IN DISTRIBUTOR.DNAME%TYPE)
LANGUAGE SQL
AS $$
...
CREATE OR REPLACE PROCEDURE UPD_DISTRI (NAMED IN DISTRIBUTOR.DNAME%TYPE,ADDR IN DISTRIBUTOR.ADDRESS%TYPE ,PH1 IN DISTRI_PHONE.PHONE%TYPE)
LANGUAGE SQL
AS $$
...
CREATE TABLE EMPLOYEES (SIN INTEGER PRIMARY KEY NOT NULL,ENAME VARCHAR(15),ADDRESS VARCHAR(50),DOB VARCHAR(15),DOJ VARCHAR(15),STORE_ID INTEGER,SALARY INTEGER, EMAIL VARCHAR(100) NOT NULL, PASSWORD VARCHAR(100) NOT NULL,UNIQUE (EMAIL));
...
CREATE TABLE CUSTOMERS (CUS_ID SMALLSERIAL PRIMARY KEY NOT NULL,CNAME VARCHAR(15),ADDRESS VARCHAR(50));
